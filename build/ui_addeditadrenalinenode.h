...
public:
    ...
    {
        AddEditAdrenalineNode->setWindowTitle(QApplication::translate("AddEditAdrenalineNode", "Add/Edit EighthCoin Node", nullptr));
        label_9->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>Enter an Alias (friendly name) for your Master Node and its address (either clearnet IP and port or Tor onion address and port). The address should be in the format 123.456.789.123:9999 or akjdsafxjkhasdf.onion:9999. You must send exactly 5000 8TH to the collateral address.</p></body></html>", nullptr));
        label_4->setText(QApplication::translate("AddEditAdrenalineNode", "Alias*", nullptr));
        label_6->setText(QApplication::translate("AddEditAdrenalineNode", "Address*", nullptr));
        label_5->setText(QApplication::translate("AddEditAdrenalineNode", "PrivKey*", nullptr));
        label_2->setText(QApplication::translate("AddEditAdrenalineNode", "TxHash*", nullptr));
        label_8->setText(QApplication::translate("AddEditAdrenalineNode", "Output Index*", nullptr));
        label_3->setText(QApplication::translate("AddEditAdrenalineNode", "Donation Address", nullptr));
        label_7->setText(QApplication::translate("AddEditAdrenalineNode", "Donation %", nullptr));
