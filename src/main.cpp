...
unsigned int nStakeMinAge = 8 * 60; // 8 min
...
int nCoinbaseMaturity = 18;  //  Coin Maturity : 18 
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
	...
	if (nHeight >= 1 && nHeight <= 50)
		nSubsidy = 888888 * COIN;
	// add fees.
...
{
	RenameThread("EighthCoin-loadblk");
