...
sudo ./configure --host=i686-w64-mingw32.static --with-bignum=no --enable-module-recovery --with-field=32bit --with-scalar=32bit --with-asm=x86_64
 sudo TARGET_OS=OS_WINDOWS_CROSSCOMPILE make CC=/mnt/mxe/usr/bin/i686-w64-mingw32.static-g++ CXX=/mnt/mxe/usr/bin/i686-w64-mingw32.static-g++ libsecp256k1.la libsecp256k1.so
sudo make install
cd ../..
